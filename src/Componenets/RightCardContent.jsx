...
const RightCardContent = (props) => {
    ...
    return (
        <div className='absolute top-0 left-0 h-full w-full p-8 flex flex-col justify-between'>
            ...
            <div>
                <p className='text-shadow-3xs text-xs leading-relaxed text-white mb-10'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iure accusamus cupiditate voluptatibus mollitia alias tempora.</p>
